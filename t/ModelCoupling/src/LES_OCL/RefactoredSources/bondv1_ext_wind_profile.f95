module module_bondv1_ext_wind_profile

contains

      subroutine bondv1_ext_wind_profile(jm,u,z2,dzn,v,w,km,n,im,dt,dxs,wind_profile)
      use common_sn ! create_new_include_statements() line 102
        ...
        real(kind=4) :: u_val
        real(kind=4), dimension(1:jp,1:kp) :: wind_profile
! 
! 
! -------------------inflow-------------------
! 
...
#endif
      return
      end subroutine bondv1_ext_wind_profile

end module module_bondv1_ext_wind_profile
