...
subroutine program_les_ocl_gmcf(sys, tile, model_id)
        ...
        use module_initial_wind_profile
#ifndef _OPENCL_LES_WV
        use module_bondv1_ext_wind_profile
#endif
#endif
        use common_sn
...
#ifdef USE_GMCF
     call gmcfInitLesOcl(sys,tile, model_id)
#endif
...
! --main loop
    ...
    call cpu_time(timestamp(8))
      ...
      do n = n0,nmax
        ...
        call gmcfInterpolateWindprofileLesOcl(wind_profile)
#endif
...
#ifdef EXTERNAL_WIND_PROFILE
#ifndef USE_GMCF
      call initial_wind_profile(wind_profile,jm,km,z2,dzn)
#endif

!      print *,"wind_profile: ",sum(wind_profile)/size(wind_profile)
#endif
      call run_LES_kernel ( &
#ifndef NO_FILE_IO
            data20, data21, &
...
#ifdef EXTERNAL_WIND_PROFILE
        call initial_wind_profile(wind_profile,jm,km,z2,dzn)
        call bondv1_ext_wind_profile(jm,u,z2,dzn,v,w,km,n,im,dt,dxs,wind_profile)
#else
...
end subroutine program_les_ocl_gmcf
