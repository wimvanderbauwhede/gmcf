...
contains
    ...
    subroutine initialise_LES_kernel (         p,u,v,w,usum,vsum,wsum,f,g,h,fold,gold,hold,         diu1, diu2, diu3, diu4, diu5, diu6, diu7, diu8, diu9,         amask1, bmask1, cmask1, dmask1,         cn1, cn2l, cn2s, cn3l, cn3s, cn4l, cn4s,         rhs, sm, dxs, dys, dzs, dx1, dy1, dzn,         wind_profile,         dt, im, jm, km         )
        use oclWrapper
...
!        real(kind=4), dimension(1:16,-1:ip+2,0:jp+2,0:kp+2)  :: nou
    ...
    init_ocl_local = 0
        ...
        wind_profile_sz = shape(wind_profile)
        ...
        call oclMake2DFloatArrayReadWriteBuffer(wind_profile_buf,wind_profile_sz ,wind_profile)
        ...
        call oclSetFloatArrayArg(15, wind_profile_buf )
        ...
        ! call LES_combined(p_scratch, uvw, uvwsum, fgh, fgh_old,             rhs, mask1, diu, sm,            dxs, dys, dzs, dx1, dy1, dzn,             wind_profile,             cn1, cn2l, cn2s, cn3l, cn3s, cn4l, cn4s,            val_ptr, chunks_num, chunks_denom, n_ptr, state_ptr, dt, im, jm, km             )
        ...
        call oclRead2DFloatArrayBuffer(wind_profile_buf,wind_profile_sz,wind_profile)
    ...
    subroutine run_LES_kernel (         n, nmax         , wind_profile         )
        use oclWrapper
        use oclWrapper
        use params_common_sn
        implicit none
